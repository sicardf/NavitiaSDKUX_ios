...
@objc open class TravelUI: NSObject {
    
    @objc public static let shared = TravelUI()
    
    open var navitiaSDK: NavitiaSDK!
    open var bundle: Bundle! {
        didSet {
            UIFont.registerFontWithFilenameString(filenameString: "SDKIcons.ttf", bundle: TravelUI.shared.bundle)
        }
    }
