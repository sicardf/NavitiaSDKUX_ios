...
class RidesharingView: UIView {
    ...
    private func setup() {
        UINib(nibName: "RidesharingView", bundle: TravelUI.shared.bundle).instantiate(withOwner: self, options: nil)
    ...
    private func bookRidesharing() {
        if let parentViewController = parentViewController {
            if !UserDefaults.standard.bool(forKey: TravelUserDefaultsManager.SHOW_REDIRECTION_DIALOG_PREF_KEY) {
                let alertController = AlertViewController(nibName: "AlertView", bundle: TravelUI.shared.bundle)
                alertController.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
                alertController.stateKey = TravelUserDefaultsManager.SHOW_REDIRECTION_DIALOG_PREF_KEY
    ...
    internal func setRating(_ count: Float?) {
        if count != nil {
            ...
            floatRatingView.emptyImage = UIImage(named: "star_empty", in: TravelUI.shared.bundle, compatibleWith: nil)
            floatRatingView.fullImage = UIImage(named: "star_full", in: TravelUI.shared.bundle, compatibleWith: nil)
