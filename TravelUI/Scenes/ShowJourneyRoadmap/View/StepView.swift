...
class StepView: UIView {
    ...
    class func instanceFromNib() -> StepView {
        return UINib(nibName: identifier, bundle: TravelUI.shared.bundle).instantiate(withOwner: nil, options: nil)[0] as! StepView
    }
    ...
    private func initRealTime() {
        ...
        realTimeImage.image = UIImage(named: "real_time", in: TravelUI.shared.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
