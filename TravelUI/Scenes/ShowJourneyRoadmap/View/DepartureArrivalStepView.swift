...
class DepartureArrivalStepView: UIView {
    ...
    class func instanceFromNib() -> DepartureArrivalStepView {
        return UINib(nibName: identifier, bundle: TravelUI.shared.bundle).instantiate(withOwner: nil, options: nil)[0] as! DepartureArrivalStepView
    }
    ...
    private func setupIcon() {
        ...
        calorieImageView.image = UIImage(named: "calorie", in: TravelUI.shared.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
