...
extension ShowJourneyRoadmapViewController {
    ...
    private func displayCenterMapButton() {
        centerMapButton.setImage(UIImage(named: "location", in: TravelUI.shared.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate), for: .normal)
    ...
    public func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        if let customAnnotation = annotation as? CustomAnnotation {
            ...
            if annotationView == nil {
                annotationView = customAnnotation.getAnnotationView(annotationIdentifier: customAnnotation.identifier, bundle: TravelUI.shared.bundle)
            } else {
