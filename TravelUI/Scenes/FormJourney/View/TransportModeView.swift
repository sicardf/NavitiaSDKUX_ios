...
class TransportModeView: UIView {
    ...
    public var isColorInverted: Bool = false {
        didSet {
            transportModeLabel.textColor = (isColorInverted ? TravelUI.shared.mainColor : Configuration.Color.white)
        }
    }
    ...
    internal func initItems() {
        for mode in Configuration.modeForm {
            ...
            newLabel.textColor = (isColorInverted ? TravelUI.shared.mainColor : Configuration.Color.white)
    ...
    internal func drawLabel() {
        ...
        transportModeLabel.attributedText = NSMutableAttributedString().bold("transport_modes".localized(), color: isColorInverted ? TravelUI.shared.mainColor : Configuration.Color.white, size: 13)
    ...
    internal func calculateOptimization() {
        ...
        if maxIconForWidth == 0 {
            print("TravelUI: Icons size too large to be displayed for transport mode")
