...
extension Disruption {
    ...
    internal func levelImage(name: String) -> UIImage? {
        switch name {
        case "information":
            return UIImage(named: "information_disruption", in: TravelUI.shared.bundle, compatibleWith: nil)
        case "nonblocking":
            return UIImage(named: "non_blocking_disruption", in: TravelUI.shared.bundle, compatibleWith: nil)
        case "blocking":
            return UIImage(named: "blocking_disruption", in: TravelUI.shared.bundle, compatibleWith: nil)
        default:
            return nil
        }
    }
